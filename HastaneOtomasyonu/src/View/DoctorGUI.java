...
public class DoctorGUI extends JFrame {
	...
	public DoctorGUI(Doctor doctor) throws SQLException {
		...
		select_time.setModel(new DefaultComboBoxModel(new String[] { "10:00", "10:30", "11:00", "11:30", "12:00",
				"12:30", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00" }));
		select_time.setBounds(150, 9, 65, 22);
		...
		btn_addWhour.setFont(new Font("Yu Gothic UI", Font.BOLD, 12));
		btn_addWhour.setBounds(225, 9, 70, 23);
		w_whour.add(btn_addWhour);

		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(0, 42, 709, 319);
		...
		btn_deleteWhour.setFont(new Font("Yu Gothic UI", Font.BOLD, 12));
		btn_deleteWhour.setBounds(629, 11, 70, 23);
