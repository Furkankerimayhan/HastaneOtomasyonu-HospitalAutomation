...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		lblNewLabel.setBounds(10, 11, 306, 39);
		...
		btnNewButton.setBounds(610, 21, 114, 23);
		w_pane.add(btnNewButton);

		JTabbedPane w_tab = new JTabbedPane(JTabbedPane.TOP);
		w_tab.setBounds(10, 61, 714, 389);
		w_pane.add(w_tab);
		...
		w_scrollDoctor.setBounds(10, 34, 260, 316);
		...
		lblNewLabel_1.setBounds(89, 0, 109, 30);
		...
		lblPoliklinikad.setBounds(280, 35, 168, 30);
		w_appointment.add(lblPoliklinikad);

		JComboBox select_clinic = new JComboBox();
		select_clinic.setBounds(280, 76, 150, 35);
		...
		btn_workerSelect.setBounds(280, 163, 150, 38);
		...
		lblPoliklinikad_1.setBounds(280, 122, 150, 30);
		w_appointment.add(lblPoliklinikad_1);

		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(439, 34, 260, 316);
		...
		lblNewLabel_1_1.setBounds(517, 0, 150, 30);
		...
		btn_addAppoint.setFont(new Font("Yu Gothic UI", Font.BOLD, 15));
		btn_addAppoint.setBounds(280, 253, 150, 38);
		w_appointment.add(btn_addAppoint);

		JLabel lblPoliklinikad_1_1 = new JLabel("Randevu ");
		lblPoliklinikad_1_1.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 16));
		lblPoliklinikad_1_1.setBounds(280, 212, 150, 30);
		...
		w_scrollAppoint.setBounds(10, 11, 689, 339);
