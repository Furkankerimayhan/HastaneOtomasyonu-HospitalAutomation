...
public class UpdateClinicGUI extends JFrame {
	...
	public UpdateClinicGUI(Clinic clinic) {
		...
		label.setBounds(10, 0, 168, 30);
		contentPane.add(label);
		
		fld_clinicName = new JTextField();
		fld_clinicName.setColumns(10);
		fld_clinicName.setBounds(10, 28, 189, 30);
		...
		btn_updateClinic.setFont(new Font("Yu Gothic UI", Font.BOLD, 15));
		btn_updateClinic.setBounds(10, 69, 189, 38);
